...
const hermesAPI = {
  ...
  checkVersionStatus: (): Promise<{
    engine: { current: string | null; latest: string | null; updateAvailable: boolean };
    desktop: { current: string | null; latest: string | null; updateAvailable: boolean };
