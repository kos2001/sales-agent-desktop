...
function Kanban({ profile, visible }: KanbanProps): React.JSX.Element {
  ...
  return (
    <div className="kanban-container">
      ...
      {/* Inline usage help — a native <details> so a returning user can
          collapse it once they know the flow. Closed by default; opens
          to a short bullet list explaining the core moves (new task,
          drag between columns, dispatch, boards). */}
      <details className="kanban-help">
        <summary className="kanban-help-summary">
          {t("kanban.help.summary")}
        </summary>
        <div className="kanban-help-body">
          <p className="kanban-help-intro">{t("kanban.help.intro")}</p>
          <ul className="kanban-help-list">
            <li>{t("kanban.help.tip1")}</li>
            <li>{t("kanban.help.tip2")}</li>
            <li>{t("kanban.help.tip3")}</li>
            <li>{t("kanban.help.tip4")}</li>
          </ul>
        </div>
      </details>
