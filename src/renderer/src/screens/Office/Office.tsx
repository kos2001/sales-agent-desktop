...
function Office({
  ...
  return (
    <div className="office-ready">
      ...
      {/* Inline usage help — same disclosure pattern as the Kanban screen.
          Native <details> keeps the help visible-but-collapsible without
          taking layout space until the user explicitly opens it. */}
      <details className="office-help">
        <summary className="office-help-summary">
          {t("office.help.summary")}
        </summary>
        <div className="office-help-body">
          <p className="office-help-intro">{t("office.help.intro")}</p>
          <ul className="office-help-list">
            <li>{t("office.help.tip1")}</li>
            <li>{t("office.help.tip2")}</li>
            <li>{t("office.help.tip3")}</li>
            <li>{t("office.help.tip4")}</li>
          </ul>
        </div>
      </details>
