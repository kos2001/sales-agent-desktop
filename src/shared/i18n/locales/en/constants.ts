export default {
  ...
  sectionCustomHeaders: "Custom Request Headers",
  serviceIdLabel: "Service-Id",
  serviceIdHint:
    "Sent as the Service-Id header on every chat request. Used by internal OpenAI-compatible gateways (including OpenRouter through a corporate proxy) for billing or audit. Leave blank to disable.",
  userIdLabel: "User-Id",
  userIdHint:
    "Sent as the User-Id header on every chat request. Pair with Service-Id when your gateway requires both.",
